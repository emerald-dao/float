...
{:then addressObject}
  <article>
    <header class="text-center">
      ...
      data-tooltip="Paste into Discord">
      ...
      <span class="command">/groupverifier {$page.params.address} {group.name} role:</span>
    </div>
    <CopyBadge text={`/groupverifier creator:${$page.params.address} groupname:${group.name} role:`}></CopyBadge>
    </header>

...
export default function GraffleSDK() {
  ...
  let negotiateResult;
  const projectID = import.meta.env.VITE_GRAFFLE_MAINNET_PROJECT_ID;

  const negotiate = async () => {

    const authHeader = {
      "graffle-api-key": import.meta.env.VITE_GRAFFLE_MAINNET_API_KEY,
      "Content-Type": "application/x-www-form-urlencoded"
    }
    const url = import.meta.env.VITE_GRAFFLE_MAINNET_API_URL;
